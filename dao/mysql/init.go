...
func InitMySQL() {
	...
	global.GVA_DB = db
	_ = global.GVA_DB.Use(dbresolver.
	...
	global.GVA_DB = global.GVA_DB.Set("gorm:table_options", "charset=utf8mb4")
	err = migrate()
	if err != nil {
		fmt.Println("gorm自动建表错误：",err)
		return
	}
}
